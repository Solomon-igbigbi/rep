...
import { SearchOutlined, InfoCircleFilled, FormOutlined, EditOutlined, BellOutlined, GlobalOutlined, PullRequestOutlined } from '@ant-design/icons';
        ...
        <Setting 
          sider={
            <div className={styles.sideWrapper}>
              <Input className={styles.input} placeholder="Search" prefix={<SearchOutlined />} />

              <Row className={styles.Ac}>
                <Col span={8}>
                  <Text variant="p" bold={true}>Account Settings</Text>
                </Col>
          ...
          header={
            ...
            }} variant="h4" bold={true}>General Settings</Text>
          }
          content={
